...
PROFILES = {
    ...
    'hmda': {
        ...
        'variables': {
            ...
            'loan_term':      {'mean': 324.8,  'std':  64.42, 'skew':-1.84, 'kurt':  5.22,
                               'dist': 'bimodal',
                               'm1': 180.0, 's1': 18.0, 'm2': 360.0, 's2': 12.0, 'w': 0.22,
                               'unit': 'months'},
    ...
    'bls': {
        ...
        'variables': {
            ...
            'establishment_size': {'mean':   18.44, 'std':  48.84, 'skew': 4.84, 'kurt': 28.42,
                                   ...
                                   'median': 4.2, 'iqr': 9.5, 'unit': 'employees'},
    ...
    'edgar': {
        ...
        'variables': {
            'revenue':           {'mean': 4842e6, 'std': 12480e6, 'skew': 4.84, 'kurt': 28.40,
                                  'dist': 'pareto', 'alpha': 1.18, 'median': 284e6, 'iqr': 820e6,
                                  'unit': 'USD'},
            'net_income_margin': {'mean':    8.44, 'std':   12.84, 'skew':-1.84, 'kurt':  8.44,
                                  'dist': 'skew_loss', 'w_loss': 0.28, 'unit': '%'},
    ...
    'fdic': {
        ...
        'variables': {
            'total_assets':       {'mean': 2848e6, 'std': 12480e6, 'skew': 5.84, 'kurt': 38.40,
                                   'dist': 'pareto', 'alpha': 1.12, 'median': 288e6, 'iqr': 726e6,
                                   'unit': 'USD'},
    ...
    'rental_market': {
        ...
        'correlations': np.array([
            ...
            [ 1.00, 1.00, 1.00,-0.14,-0.04, 0.04, 0.14,-0.04, 0.04,-0.04, 0.04, 0.04,-0.04], # placeholder
