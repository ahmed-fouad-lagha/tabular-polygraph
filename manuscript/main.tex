...
We evaluated the Hybrid Integrity Framework (HIF) on benchmark datasets representing diverse structural complexity: the U.S. Census ACS dataset \cite{uscensus2021acs, ding2021folktables}, Online Purchases, and Supermarket Sales datasets. Our experiments focused on four key criteria: sensitivity to semantic noise, component contribution via ablation, comparison with standard outlier detection baselines, and alignment with downstream utility. Experiments used $N=3\text{--}10$ random seeds depending on the evaluation; we report mean $\pm$ standard error of the mean (SEM) unless otherwise noted.
...
\midrule
\textbf{Supermarket Sales} & Gaussian Copula & 0.902 & 0.895 & 0.923 & \textbf{0.966} & \textbf{2.1\%} \\
                           & Vine Copula     & \textbf{0.973} & 0.789 & 0.880 & 0.001 & 99.9\% \\
                           & CTGAN           & 0.766 & 0.535 & 0.834 & 0.006 & 99.7\% \\
                           & TVAE            & 0.768 & 0.886 & 0.926 & 0.015 & 98.9\% \\
\midrule
\textbf{Online Purchases}  & Gaussian Copula & 0.753 & 0.491 & 0.829 & \textbf{0.386} & \textbf{65.7\%} \\
                           & Vine Copula     & \textbf{0.974} & 0.817 & 0.956 & 0.062 & 97.5\% \\
                           & CTGAN           & 0.738 & 0.438 & 0.883 & 0.072 & 96.6\% \\
                           & TVAE            & 0.767 & 0.632 & 0.684 & 0.006 & 100.0\% \\
\midrule
\textbf{Credit Default}    & Gaussian Copula & 0.744 & 0.734 & 0.945 & 0.480 & 53.7\% \\
                           & Vine Copula     & \textbf{0.974} & 0.798 & 0.812 & 0.344 & 69.1\% \\
                           & CTGAN           & 0.651 & 0.557 & 0.880 & 0.214 & 82.5\% \\
                           & TVAE            & 0.747 & 0.499 & 0.708 & \textbf{0.894} & \textbf{10.1\%} \\
\midrule
\textbf{Adult Income}      & Gaussian Copula & 0.841 & 0.937 & 0.810 & 0.711 & 28.0\% \\
                           & Vine Copula     & \textbf{0.974} & \textbf{0.966} & 0.799 & 0.631 & 36.2\% \\
                           & CTGAN           & 0.728 & 0.785 & 0.775 & 0.523 & 46.7\% \\
                           & TVAE            & 0.725 & 0.449 & 0.490 & \textbf{0.972} & \textbf{1.1\%} \\
\bottomrule
\end{tabular}
\end{table}
