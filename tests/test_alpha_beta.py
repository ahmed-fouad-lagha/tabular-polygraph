...
from tabular_polygraph.fidelity.alpha_beta import (
    _encode_for_alpha_precision,
...
class TestAlphaPrecisionBetaRecall:
    def test_identical_data_high_scores(self):
        ...
        result = alpha_precision_beta_recall(df, df)
    ...
    def test_random_vs_structured_low_precision(self):
        ...
        result = alpha_precision_beta_recall(real, syn)
    ...
    def test_mismatched_rows_raises(self):
        ...
        with pytest.raises(ValueError, match="same number of rows"):
            alpha_precision_beta_recall(real, syn)
